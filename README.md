...
## 介绍  
[test](https://github.com/wjz304/test)

[![](https://img.shields.io/github/issues-search?label=%E5%AE%9A%E5%88%B6%E6%AC%A1%E6%95%B0&query=repo%3Awjz304%2Ftest%20label%3Acustom)](https://github.com/wjz304/test/issues?q=label%3Acustom)
[![](https://img.shields.io/github/issues-search?label=%E6%AF%8F%E6%97%A5%E6%9E%84%E5%BB%BA&query=repo%3Awjz304%2Ftest%20label%3Aschedule)](https://github.com/wjz304/test/issues?q=label%3Aschedule)

## 说明  
方式一：  
在本项目 Issues 中创建问题，按需填写即可发起定制构建。  
【👉[快速创建](https://wjz304.github.io/test/Issues.html)】 【👉[图文说明](https://github.com/wjz304/test/blob/main/guide/Issues.md)】 【👉[参考示例issue#1](https://github.com/wjz304/test/issues/1)】  【👉[驱动支持表](https://xpenology.com/forum/topic/4980-gt-hardware-supported-list-for-dsm-52-lt/)】  【👉[json错误检测](https://json-online.com/check/)】  
...
5. 打上 ['schedule'](https://github.com/wjz304/test/blob/main/guide/Issues.md#issues-%E6%AF%8F%E6%97%A5%E5%BE%AA%E7%8E%AF%E6%9E%84%E5%BB%BA%E6%95%99%E7%A8%8B)   标签 将会每日构建(通过Reopen的方式, 因此如果构建失败Issues没有Closed 将终止).  
6. [必读！！！](./tips.md)
...
dtb       | ×    |-               | dtb文件下载URL(support ext: .dts,.dtb,.tar.gz,.zip) [#47](https://github.com/wjz304/test/issues/47)
...
- eg:
  ...
  - {"platform":"DS920+", "version":"7.0.1-42218", "dtb": "https://github.com/wjz304/test/files/9235785/ds920p.zip", "ext":"r8125"}  
  - {  
      "platform":"DS3622xs+",  
      "version":"7.0.1-42218",  
      "jun":"1",  
...
####  body 高级自定义：
请在 body 中 以 \`\`\`  \`\`\` 包裹自定义的 shell 命令, 将在 build 前运行. 参考[#3](https://github.com/wjz304/test/issues/3)  
eg：  
- \`\`\`  
